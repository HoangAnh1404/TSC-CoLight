...
if __name__ == '__main__':
    ...
    log_path = path_convert(f'./result/{env_name}/{tls_action_type}/log/')
    model_path = path_convert(f'./result/{env_name}/{tls_action_type}/models/')
    tensorboard_path = path_convert(f'./result/{env_name}/{tls_action_type}/tensorboard/')
    ...
    # Init Env
    # #########
    sumo_cfg = path_convert(f"../Scenario/{env_name}/env/vehicle.sumocfg")
    net_file = path_convert(f"../Scenario/{env_name}/env/{env_name}.net.xml")
    params = {
        'tls_id':'J1',
        'num_seconds':500,
    ...
    model.learn(total_timesteps=5e4, tb_log_name='J1', callback=callback_list)
