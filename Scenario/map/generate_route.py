...
generate_route(
    ...
    #     'E7__E8': [5]*len(interval),
    #     'E8__E7': [5]*len(interval),
    # },
    veh_type={
    ...
    output_route=current_file_path('./routes/binh_thuong/vehicle.rou.xml'),
